...
searchButton.addEventListener('click', function () {
  ...
  fetch('http://www.omdbapi.com/?apikey=29018eae&s=' + inputKeyword.value).then(
    (response) =>
      response.json().then((response) => {
        ...
        modalDetailButton.forEach((btn) => {
          btn.addEventListener('click', function () {
            ...
            fetch('http://www.omdbapi.com/?apikey=29018eae&i=' + imdbid)
...
function getMovies(keyword) {
  return fetch('http://www.omdbapi.com/?apikey=29018eae&s=' + keyword)
    .then((response) => response.json())
...
function getMovieDetail(imdbid) {
  return fetch('http://www.omdbapi.com/?apikey=29018eae&i=' + imdbid)
    .then((response) => response.json())
    .then((m) => m);
}
